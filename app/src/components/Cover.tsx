    ...
    if (xmlJson['iso-standard']) {
        ...
        if (xmlJson['ogc-standard']['bibdata']) {
            ...
            if (bibdata?.docidentifier) {
                ...
                let internalRow: any = Object.values(
                    bibdata.docidentifier
                ).find((child: any) => {
                    if (child?.$?.type && child?.$?.type === 'ogc-internal')
                        return true;
                    return false;
                });
                ...
                <header>
                    <div className="ogc-coverpage">
                        <div className="ogc-wrapper-top">
                            ...
                            <div className="ogc-authors">
                                <span>
                                    {editor}
                                    <span className="ogc-roletag">Editor</span>
                                </span>
                            </div>
                            <div className="ogc-coverpage-metadata">
